...
public enum HttpStatusCode {
    ...
    CLIENT_ERROR_401_UNAUTHORIZED(401, "USER UNAUTHORIZED"),
    CLIENT_ERROR_409_DUPLICATED_USER(409,"DUPLICATED USER"),
    CLIENT_ERROR_403_FORBIDDEN(403, "Access forbidden"),
